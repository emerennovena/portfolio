      ...
      <div className="space-y-2">
        ...
        <div>
          <a
            ...
            className="inline-block px-4 py-2 text-sm font-medium text-white bg-zinc-900 text-xs rounded-md hover:bg-zinc-700 transition"
            >
              Live Demo
            </a>
        </div>
...
const Projects: React.FC = () => {
  const projects = [
    {
      title: "LanguaTale - Language Learning Web App",
      description:
        "Developed an interactive story-driven app for language learners, integrating InkJS to create branching narratives.",
      image: "/languatale.png",
      techStack: ["Django", "InkJS", "Python", "JavaScript", "HTML", "CSS"],
      liveURL:"https://languatale.pythonanywhere.com",
    },
    {
      title: "CinemaTown - Movie Review Web App",
      description:
        "Built a Django-based movie review platform where users can browse and review 50+ movies.",
      image: "/cinematown.jpg",
      techStack: ["Django", "Python", "JavaScript", "HTML", "CSS"],
    },
        {
      title: "Puppy Animation",
      description:
        "Built a Puppy Animation wagging its tail using HTML and CSS",
      image: "/dog.png",
      techStack: ["HTML", "CSS"],
      liveURL: "https://puppy-animation.vercel.app",
    },
        {
      title: "Burger Animation",
      description:
        "Built a Burger Animation that animates when hovered over it using HTML and CSS",
      image: "/burger.png",
      techStack: ["HTML", "CSS"],
      liveURL:"https://burger-animation.vercel.app",
    },
    // {
